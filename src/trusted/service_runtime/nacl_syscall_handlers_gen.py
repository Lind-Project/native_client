...
SYSCALL_LIST = [
    ...
    ('NACL_sys_fstatfs', 'NaClSysFstatfs', ['int d', 'struct nacl_abi_statfs *buf']),
    ('NACL_sys_statfs', 'NaClSysStatfs', ['const char *path', 'struct nacl_abi_statfs *buf']),
