 ...
 * 4GB file max
 */
extern uintptr_t NaClMapHelper(int                 fd,
                              int                 cageid,
                              void                *start_addr,
                              size_t              len,
                              int                 prot,
 ...
 */
extern int NaClUnmapUnsafeHelper(void *start_addr, size_t len) NACL_WUR;
 ...
 */
extern int NaClOpenHelper( int                   cageid,
                          char const           *path,
                          int                  flags,
                          int                  mode) NACL_WUR;


extern ssize_t NaClReadHelper(int                    fd,
                            int                  cageid,
                            void                 *buf,
                            size_t               len) NACL_WUR;
 ...
 */
extern ssize_t NaClWriteHelper(int                  fd,
                              int                  cageid,
                              void const          *buf,
                              size_t              len) NACL_WUR;
 ...
 */
extern ssize_t NaClPWriteHelper(int                  fd,
                        int                   cageid,
                        void const            *buf,
                        size_t                len,
                        nacl_off64_t          offset) NACL_WUR;

extern nacl_off64_t NaClSeekHelper(int                  fd,
                                  int                  cageid,
                                  nacl_off64_t         offset,
                                  int                  whence);
 ...
 * Fstat.
 */
extern int NaClFstatHelper(int                  fd,
                    int                  cageid,
                    nacl_host_stat_t     *nhsp) NACL_WUR;
